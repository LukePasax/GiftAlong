...
class MapActivity: AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(View(AppContext.getContext()!!))
        // [START_EXCLUDE silent]
        ...
        MapView(AppContext.getContext()!!).getMapAsync(this)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.title.toString() == "Get place") {
            showCurrentPlace()
        }
        return true
    }
    ...
    private fun showCurrentPlace() {
        ...
        if (locationPermissionGranted) {
            ...
            map?.addMarker(MarkerOptions().title("Default Marker").position(defaultLocation).snippet("Default Marker"))
            // Prompt the user for permission.
            getLocationPermission()
        }
    }
    ...
    private fun openPlacesDialog() {
        ...
        val listener = DialogInterface.OnClickListener { _, which ->
            ...
            map?.addMarker(MarkerOptions().title(likelyPlaceNames[which]).position(markerLatLng).snippet(markerSnippet))

            // Position the map's camera at the location of the marker.
            map?.moveCamera(CameraUpdateFactory.newLatLngZoom(markerLatLng, DEFAULT_ZOOM.toFloat()))
        }
        // Display the dialog.
        AlertDialog.Builder(this).setTitle("Pick a place").setItems(likelyPlaceNames, listener).show()
    }
